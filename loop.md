...
if tickets exist then 2. grab the next available ticket and implement it if you cannot complete it, leave notes in the ./notes folder if you can complete it, then commit what you have using 'conventional commits' you MUST mention Closes #ticket-number to advance the board!
